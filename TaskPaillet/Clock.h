...
class Clock : public Singleton<Clock>
{
    ...
    wstr_t	tickToStr(tick_t tick, WCHAR *fmt = (WCHAR*)DATETIME_FORMAT);
...
public:
    ...
    tick_t	systemTick();
    tick_t	strToTick(wstr_t str, WCHAR *fmt = (WCHAR*)DB_TIME_FORMAT);
    
    wstr_t	nowTime(WCHAR *fmt = (WCHAR*)DATETIME_FORMAT);
    wstr_t	nowTimeWithMilliSec(WCHAR *fmt = (WCHAR*)DATETIME_FORMAT);
